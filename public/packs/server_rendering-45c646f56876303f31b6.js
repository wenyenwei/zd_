...
throw new Error("Module build failed: SyntaxError: Adjacent JSX elements must be wrapped in an enclosing tag (75:14)\n\n  73 |       for (var item in ticket){\n  74 |         <label>Subject</label>\n> 75 |               <textarea\n     |               ^\n  76 |                 value={ticket[item]}\n  77 |                 onChange={event => this.setState({[ticket[item]]: event.target.value})}\n  78 |               />\n");
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-45c646f56876303f31b6.js.map