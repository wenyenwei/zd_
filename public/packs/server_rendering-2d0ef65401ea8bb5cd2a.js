...
throw new Error("Module build failed: SyntaxError: this is a reserved word (107:32)\n\n  105 |                     mutation: EDIT_TICKET,\n  106 |                     variables: { \n> 107 |                       subject: {this.state.subject},\n      |                                 ^\n  108 |                       description: {this.state.description}\n  109 |                       status: {this.state.status}\n  110 |                       priority: {this.state.priority}\n");
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-2d0ef65401ea8bb5cd2a.js.map